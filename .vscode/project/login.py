...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed by Aman Kothari")
        ...
        titl=Label(login_frame,text="Login System",font=("Elephant",30,"bold"),bg="white").place(x=0,y=30,relwidth=1)
        ...
        btn_login=Button(login_frame,command=self.login,text="Log In",font=("Arial Rounded MT Bold",15),bg="#00B0F0",activebackground="#00B0F0",cursor="hand2").place(x=50,y=300,width=250,height=35)
...
#================Register Frame=====================
        ...
        lbl_reg= Label(register_frame,text="For any query Contact: Code Crusaders\n<ak5518786@gmail.com>",font=("times new roman",13),bg="white").place(x=40,y=10)
    ...
    def animate(self):
         self.im=self.MemLog
         self.MemLog=self.MemLog2
         self.MemLog2=self.MemLog3
         self.MemLog3=self.im
