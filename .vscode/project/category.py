...
#===========title============================================
        ...
        self.categoryTable=ttk.Treeview(cat_frame,columns=("cid","name"),yscrollcommand=scrolly.set, xscrollcommand=scrollx.set,show="headings")
        ...
        #images====
        self.im1 = PhotoImage(file="category.png")
        self.lbl_im1 = Label(self.root, image=self.im1,bd=2,relief=RAISED)
        self.lbl_im1.place(x=50, y=232,height=260,width=490)

        self.im2 = PhotoImage(file="cat2.png")
        self.lbl_im2 = Label(self.root, image=self.im2,bd=2,relief=RAISED)
        self.lbl_im2.place(x=580, y=232,height=260, width=500)
...
#=============functions==============================================
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
               ...
               row=cur.fetchone()
               if row!=None:
                   messagebox.showerror("Error","Category already present, try different value",parent=self.root)
               else:
    ...
    # Debug print statements to understand the contents of row
          print(row)
          print(len(row))
